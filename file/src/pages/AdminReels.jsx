        ...
        <MasterLayout>
            ...
            <div className='card h-100 p-0 radius-12 overflow-hidden border-0 shadow-sm'>
                <div className='card-header border-bottom bg-base py-16 px-24 d-flex align-items-center justify-content-between'>
                    ...
                    <span className="badge bg-primary-focus text-primary-main px-16 py-8 radius-pill fw-bold">
                        ...
                        <div className='row gy-4'>
                            {reels.length > 0 ? reels.map((reel) => (
                                <div className='col-xxl-3 col-md-4 col-sm-6' key={reel._id}>
                                    <div 
                                        className='card border-0 bg-black radius-16 overflow-hidden shadow-sm h-100 position-relative cursor-pointer transition-all'
                                        style={{ height: '400px' }}
                                    ...
                                    >
                                        ...
                                        <button 
                                            ...
                                            className='btn btn-danger w-36-px h-36-px d-flex justify-content-center align-items-center position-absolute top-0 end-0 m-12 z-2 radius-8 shadow-lg border-0 opacity-75 hover-opacity-100'
                                        >
                                        ...
                                        <div className="position-absolute bottom-0 w-100 p-16" style={{ background: 'linear-gradient(transparent, rgba(0,0,0,0.9))' }}>
                                            
                                            {/* 🌟 Linked Product Name (Glassy Look & Correct Alignment) */}
                                            {reel.productId && (
                                            ...
                                            {/* 🌟 Description - Grid-laye theriya update panniyaachu */}
                                            ...
                                            <div className="d-flex align-items-center gap-2 mb-8">
                                                <small className="text-white-50 fw-bold text-truncate text-xxs">@{reel.sellerId?.shopName || "Zhopingo"}</small>
                                            </div>

                                            <div className="d-flex align-items-center text-white gap-2">
                                                {/* 🌟 FULLY TRANSPARENT HEART ICON */}
                ...
                <div className="position-fixed top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center z-3" style={{ backgroundColor: 'rgba(0,0,0,0.95)', zIndex: 99999 }} onClick={() => setViewReel(null)}>
                    <div className="position-relative animate__animated animate__zoomIn" style={{ width: '100%', maxWidth: '380px', height: '85vh' }} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="position-absolute bottom-0 w-100 p-24 radius-24" style={{ background: 'linear-gradient(transparent, rgba(0,0,0,0.95))' }}>
                            ...
                            <p className="text-white-50 text-xs mb-16 px-1">{viewReel.description}</p>
                            {viewReel.productId && (
                                <div className="p-12 radius-16 d-flex align-items-center shadow-lg border border-white-10" 
                                     style={{ background: 'rgba(255, 255, 255, 0.12)', backdropFilter: 'blur(15px)' }}>
            ...
            {/* DELETE CONFIRM MODAL (Logic unchanged) */}
            {deleteModal.show && (
