        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            ...
            <li>
              ...
              >
                <Icon
                  icon='solar:home-smile-angle-outline'z
                  className='menu-icon'
                />
                <span>Dashboard</span>
              </NavLink>
    ...
    <span>Attributes</span>
            ...
            <li className='dropdown'>
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <NavLink to='/email'>
                    <i className='ri-circle-fill circle-icon text-primary-600' /> Reports (Email)
                  </NavLink>
                </li>
                <li>
                  <NavLink to='/chat-message'>
                    <i className='ri-circle-fill circle-icon text-warning-main' /> Seller Tickets
                  </NavLink>
                </li>
              </ul>
            </li>
